...
TForm1 *Form1;
   ...
   char kto;     //
   int juz;    //poruszanie siê kursora(podswietlanie)
   int ruch, runda=1;     //kogo ruch, zliczanie rund)
   int w_o=0;             //zliczanie o
   int w_x=0;             //zliczanie x
  ...
  void sprawdz()
   ...
   ruch++;
       if((p1==p2 && p2==p3 && p3==p4 && p4==p5 && p1!='n') ||
         ...
         (p5==p10 && p10==p15 && p15==p20 && p20==p25 && p25!='n') ||
